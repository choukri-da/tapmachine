...
import assets, { getMachineImages,} from './assets';
...
const products = [
  ...
  // 1. Batteur de tapis
  {
    ...
    images: getMachineImages('batteur'),
    link: "/produits/1",
    details:  (
  ...
  // 2. Catégorie Centrifugeuses
  {
    id: 'centrifugeuses',
    name: "Centrifugeuses",
    machineId: "centrifugeuse",
    img: assets.affichage.centrifugeuse,
    images: getMachineImages('centrifugeuse'),
    isCategory: true,
    subProducts: [
      {
        id: 2,
        name: "Centrifugeuse à tapis de mosquée",
        machineId: "centiMosquee",
        img: assets.affichage.centiMosquee,
        images: getMachineImages('centiMosquee'),
        link: "/produits/centrifugeuse-mosquee",
        details: (
      <div className="product-details">
        <h2>Avantages</h2>
        <ul>
      ...
      {
        id: 3,
        name: "Centrifugeuse Standard", 
        machineId: "centrifugeuse",
        img: assets.affichage.centrifugeuse,
        images: getMachineImages('centrifugeuse'),
        link: "/produits/centrifugeuse-standard",
        details:(
      <div className="product-details">
        <h2>Avantages</h2>
        <ul>
  ...
  // 3. Catégorie Machines à laver
  {
    id: 'lavage',
    name: "Machines à laver",
    machineId: "lavage",
    img: assets.affichage.lavage,
    images: getMachineImages('lavage'),
    isCategory: true,
    subProducts: [
      {
        id: 4,
        name: "Laveuse Standard",
        machineId: "lavage",
        img: assets.affichage.lavage,
        images: getMachineImages('lavage'),
        link: "/produits/laveuse-standard",
        details: (
      <div className="product-details">
        <h2>Avantages</h2>
        <ul>
      ...
      },
      {
        id: 5,
        name: "Laveuse 2-en-1",
        machineId: "lavage2en1",
        img: assets.affichage.lavage2en1,
        images: getMachineImages('lavage2en1'),
        link: "/produits/laveuse-2en1",
        details: (
      <div className="product-details">
        <h2>Avantages</h2>
        <ul>
  ...
  // 4. Catégorie Machines d'emballage
  {
    id: 'emballage',
    name: "Machines d'emballage",
    machineId: "emballage",
    img: assets.affichage.emballage,
    images: getMachineImages('emballage'),
    isCategory: true,
    subProducts: [
      {
        id: 6,
        name: "Table d'emballage standard",
        machineId: "emballage",
        img: assets.affichage.emballage,
        images: getMachineImages('emballage'),
        link: "/produits/emballage-standard",
        details: (
      <div className="product-details">
        <h2>Avantages</h2>
        <ul>
      ...
      {
        id: 7,
        name: "Table avec brosse",
        machineId: "emballageBrosse",
        img: assets.affichage.emballageBrosse,
        images: getMachineImages('emballageBrosse'),
        link: "/produits/emballage-brosse",
        details: (
      <div className="product-details">
        <h2>Avantages</h2>
        <ul>
  ...
  // 5. Cabine de séchage
  {
    ...
    images: getMachineImages('secheuse'),
    link: "/produits/9",
    details: (
      <div className="product-details">
        <h2>Avantages</h2>
